...
\label{sec:orgc0f6afb}
\subsection{Schéma expliquant la démarche prise}
\label{sec:orga4250a2}

\begin{figure}[htbp]
\centering
\includegraphics[width=300px]{../ressources/hyb_reduc.png}
\caption{\label{fig:org64b4bbb}Schéma expliquant la démarche prise}
\end{figure}

\subsection{Explication du code}
\label{sec:org7131080}
...
\label{sec:org774a664}
\subsection{Initialisation}
\label{sec:org939b859}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=300px]{../ressources/m.png}

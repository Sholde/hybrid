...
\label{sec:org486c6d1}
\subsection{Schéma expliquant la démarche prise}
\label{sec:org6e86c79}

\begin{figure}[htbp]
\centering
\includegraphics[width=300px]{../ressources/hyb_reduc.png}
\caption{\label{fig:orgb456a04}Schéma expliquant la démarche prise}
\end{figure}

\subsection{Explication du code}
\label{sec:org414739c}
...
\label{sec:org53d1834}
\subsection{Initialisation}
\label{sec:org4f74da0}
